...
;!function(){
  ...
  //字符常量
  ,MOD_NAME = 'laydate', ELEM = '.laydate', THIS = 'this', SHOW = 'show', HIDE = 'hide', DISABLED = 'laydate-disabled', TIPS_OUT = '开始日期超出了结束日期<br>建议重新选择', LIMIT_YEAR = [100, 200000]
  
  ,ELEM_STATIC = 'laydate-static', ELEM_LIST = 'laydate-list', ELEM_SELECTED = 'laydate-selected', ELEM_HINT = 'laydate-hint', ELEM_PREV = 'laydate-day-prev', ELEM_NEXT = 'laydate-day-next', ELEM_FOOTER = 'laydate-footer', ELEM_CONFIRM = '.laydate-btns-confirm', ELEM_TIME_TEXT = 'laydate-time-text', ELEM_TIME_BTN = '.laydate-btns-time'
  ...
  */
  ...
  Class.prototype.init = function(){
    ...
    that.elemID = 'laydate'+ options.elem.attr('lay-key');
  ...
  Class.prototype.render = function(){
    ...
    lay.each(new Array(2), function(i){
      ...
      var divHeader = lay.elem('div', {
        'class': 'laydate-header'
      })
      
      //左右切换
      ,headerChild = [function(){ //上一年
        var elem = lay.elem('i', {
          'class': 'icon laydate-icon laydate-prev-y'
        });
        elem.innerHTML = '&#xe65a;';
        return elem;
      }(), function(){ //上一月
        var elem = lay.elem('i', {
          'class': 'icon laydate-icon laydate-prev-m'
        });
        elem.innerHTML = '&#xe603;';
        return elem;
      }(), function(){ //年月选择
        ...
        var elem = lay.elem('i', {
          'class': 'icon laydate-icon laydate-next-m'
        });
        elem.innerHTML = '&#xe602;';
        return elem;
      }(), function(){ //下一年
        var elem = lay.elem('i', {
          'class': 'icon laydate-icon laydate-next-y'
        });
        elem.innerHTML = '&#xe65b;';
        return elem;
      }()]
      ...
      elemMain[i] = lay.elem('div', {
        'class': 'laydate-main laydate-main-list-'+ i
      });
    ...
    if(/^#/.test(options.theme)){
      ...
      ,styleText = [
        '#{{id}} .laydate-header{background-color:{{theme}};}'
        ,'#{{id}} .this{background-color:{{theme}} !important;}'
