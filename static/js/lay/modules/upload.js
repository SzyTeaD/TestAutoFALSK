...
layui.define('layer' , function(exports){
  ...
  //字符常量
  ,MOD_NAME = 'upload', ELEM = '.upload', THIS = 'this', SHOW = 'show', HIDE = 'hide', DISABLED = 'disabled'
  
  ,ELEM_FILE = 'upload-file', ELEM_FORM = 'upload-form', ELEM_IFRAME = 'upload-iframe', ELEM_CHOOSE = 'upload-choose', ELEM_DRAG = 'upload-drag'
  ...
  Class.prototype.file = function(){
    ...
    if(device.ie && device.ie < 10){
      options.elem.wrap('<div class="upload-wrap"></div>');
    }
  ...
  Class.prototype.events = function(){
    ...
    ,setChooseText = function(files, filename){
      ...
      elemFile.after('<span class="inline '+ ELEM_CHOOSE +'">'+ value +'</span>');
    };
