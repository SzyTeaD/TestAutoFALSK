...
layui.define('jquery', function(exports){
  ...
  ,util = {
    ...
    fixbar: function(options){
      var ELEM = 'fixbar', TOP_BAR = 'fixbar-top'
      ...
      ,elem = $(['<ul class="'+ ELEM +'">'
        ,options.bar1 ? '<li class="icon" lay-type="bar1" style="'+ options.bgcolor +'">'+ icon[0] +'</li>' : ''
        ,options.bar2 ? '<li class="icon" lay-type="bar2" style="'+ options.bgcolor +'">'+ icon[1] +'</li>' : ''
        ,'<li class="icon '+ TOP_BAR +'" lay-type="top" style="'+ options.bgcolor +'">'+ icon[2] +'</li>'
      ,'</ul>'].join(''))
